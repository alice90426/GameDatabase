...
### Bonus Symbol
- 6 [BN] on 2 and 4 reels trigger Feature Games and win 3X total play amount.
...
- More cascading times with high multiplier from 1X, 2X, 4X, 6X, up to 10X.
- Free Game has 20 free spins.

### Bonus Game1
- Award from 1X, 2X, 10X, 20X, 38X, 60X, 160X, 280X, 440X, up to 800X multiplier.

### Bonus Game2
- Award from 2X, 15X, 45X, 160X, up to 500X multiplier.
---